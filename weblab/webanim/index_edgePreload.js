...
var plSTF="both",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="650px",plHeight="780px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['293px', '358px','64px','64px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/713.gif','0px','0px']
    }]};//simpleContent
